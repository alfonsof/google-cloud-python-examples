...
# Copy an object from a Google Storage bucket to another Google Storage bucket.
...
def main():
  ...
  args = sys.argv[1:]
  if len(args) < 3:
    print('Not enough parameters.\nProper Usage is: python cloudstoragecopy.py <SOURCE_BUCKET> <SOURCE_OBJECT> <DESTINATION_BUCKET>')
    sys.exit(1)
